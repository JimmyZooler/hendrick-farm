...
//						the_custom_logo();
				...
				<?php wp_nav_menu(
					array(
						...
						'container_class' => 'navbar-collapse white-bg-modal',
						'container_id'    => 'menu-modal-wrap',
    ...
    <div class="overlay--for-menu hide zero-opacity"></div>
