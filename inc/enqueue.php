...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'understrap-styles', get_stylesheet_directory_uri() . '/css/theme.min.css', array(), '3.9' );
//		wp_enqueue_script( 'jquery', get_template_directory_uri() . '/src/js/jquery.min.js');
        ...
        wp_enqueue_script( 'custom-scripts', get_template_directory_uri() . '/src/js/scripts.js', array('jquery'), '1.9', true );
